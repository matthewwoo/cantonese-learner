          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-foreground">
                粵語學習 <span className="text-sm font-normal text-muted-foreground">Cantonese Learner</span>
              </h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          <h2 className="text-4xl font-extrabold text-foreground sm:text-5xl md:text-6xl">
            <span className="block text-foreground">學粵語</span>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="/auth/signup">🚀 開始學習 Get Started Free</Link>
            </Button>
            <Button variant="secondary" asChild>
              <Link href="/auth/signin">已有帳戶 Sign In</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">為什麼選擇我們？ Why Choose Us?</h3>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-card rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3">智能閃卡 Smart Flashcards</h4>
            ...
            <div className="bg-card rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3">AI對話 AI Conversations</h4>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3">進度追踪 Progress Tracking</h4>
              <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="mt-24 bg-card rounded-2xl shadow-xl p-12">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-foreground mb-4">學習路徑 Your Learning Journey</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">1. 基礎詞彙 Basic Vocabulary</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">2. 對話練習 Practice Conversations</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-foreground mb-2">3. 流利表達 Fluent Expression</h4>
        ...
        <div className="mt-20 text-center">
          <h3 className="text-2xl font-bold text-foreground mb-4">準備好開始了嗎？ Ready to Start?</h3>
